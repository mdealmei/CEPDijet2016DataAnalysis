...
# with command line options: MinBias_13TeV_pythia8_TuneCUETP8M1_cfi -n 350000 --fast --conditions auto:run2_mc --magField 38T_PostLS1 --beamspot Realistic25ns13TeV2016Collision -s GEN,SIM,RECOBEFMIX --eventcontent FASTPU --datatier GEN-SIM-RECO --era Run2_25ns --fileout minbias.root
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(140000)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('MinBias_13TeV_pythia8_TuneCUETP8M1_cfi nevts:350000'),

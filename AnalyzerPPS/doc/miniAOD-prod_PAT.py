...
# with command line options: miniAOD-prod -s PAT --eventcontent MINIAODSIM --runUnscheduled --fast --conditions 80X_mcRun2_asymptotic_2016_miniAODv2 --era Run2_2016 --customise_commands del process.patTrigger; del process.selectedPatTrigger --no_exec --filein readHepMC_cff_py_GEN_SIM_RECOBEFMIX_DIGI_RECO.root
...
# path to rootfiles
#path = '/afs/cern.ch/work/m/mthiel/private/ANALYZER/CMSSW_8_0_6/src/amostras_miniAOD/exclusivo/analysis_uerj/'
#source = []
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:GluGluTo2Jets_PU.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('miniAOD_GluGluTo2Jets_PU.root'),
#    outputCommands = cms.untracked.vstring('keep *_ppssim_*_*'),
    outputCommands = process.MINIAODSIMEventContent.outputCommands+cms.untracked.vstring('keep *_ppssim_*_*')+cms.untracked.vstring('keep *_genParticles_*_*'),
